...
class ImageViewer {
  ...
  registerEvents() {
    ...
    btnSelectAll.addEventListener("click", () => {
      ...
      let imgSelected = Array.from(imgList).every((image) =>
    ...
    btnSend.addEventListener("click", () => {
      ...
      let imgSelectSend = Array.from(
        this.element.querySelectorAll(".selected")
      );
      ...
      images.forEach((element) => {
        imageAvailable(element).then((isImg) => {
          if (isImg) {
            ...
            document
              .querySelector(".images-list .grid .row")
              .append(imageElement);
          }
        });
      });
  ...
  checkButtonText() {
    ...
    let imgSelected = Array.from(
      this.element.querySelectorAll(".row .four img")
    );
